...
if nd != 0:
    ...
    if bu:   
        ...
        if optfit == 'Lineal':
            ...
            st.markdown('####'+stri)
            st.markdown("### Gráfica:")
            ax.plot(xdata, ydata,marke,color=mcolor,ms = 8,mec = 'k',mew=0.4,label='Experimento')
            ...
            ax.plot(xdata, ydata,marke,color=mcolor,ms = 8,mec = 'k',mew=0.8,label='Experimento')
