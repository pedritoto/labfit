...
if nd != 0:
    ...
    if bu:   
        ...
        if optfit == 'Lineal':
            ...
            st.markdown('####'+stri)
            st.markdown("### Gráfica:")
            ax.plot(xdata, ydata,marke,color=mcolor,ms = 7,mec = 'k',mew=1.0,label='Experimento')
            ...
            ax.plot(xdata, ydata,marke,color=mcolor,ms = 7,mec = 'k',mew=0.5,label='Experimento')
